...
const portfolio = [
  ...
  {
    name: "Olde Stonewall Golf Club",
    url: "oldestonewall.com",
    href: "/sites/olde-stonewall",
    category: "Golf Course",
    desc: "#1 Public Course in PA. Walking-only, carved from a reclaimed strip mine. Hurdzan/Fry design, 7,103 yards. Shakespeare's Restaurant on site.",
    image: "/sites/olde-stonewall/hero.jpg",
    logo: "/sites/olde-stonewall/logo.png",
  },
  {
    name: "Lake Arthur Golf Club",
    url: "lakearthurgolf.com",
    href: "/sites/lake-arthur-golf",
    category: "Golf Course",
    desc: "Classic 1958 layout by Wynn Tredway. Fully irrigated 18 holes with lake views and mature hardwoods. Butler County's hidden gem.",
    image: "/sites/lake-arthur/hero.jpg",
    logo: "/sites/lake-arthur/logo.png",
  },
  {
    name: "Aubrey's Dubbs Dred Golf Course",
    url: "dubbsdred.com",
    href: "/sites/dubbs-dred",
    category: "Golf Course",
    desc: "Family-owned since 1964. Par 71, 6,945 yards of rolling Butler County farmland. Eva's Tee House restaurant on site.",
    image: "/sites/dubbs-dred/hero.jpg",
    logo: "/sites/dubbs-dred/logo.png",
  },
  {
    name: "Black Hawk Golf Course",
    url: "blackhawkgolf.com",
    href: "/sites/black-hawk-golf",
    category: "Golf Course",
    desc: "36 holes, 5th generation family-owned since 1927. Two full 18-hole courses and Hawk's Nest Taverne. Beaver County landmark.",
    image: "/sites/black-hawk/hero.jpg",
    logo: "/sites/black-hawk/logo.png",
  },
  {
    name: "Cranberry Highlands Golf Course",
    url: "cranberryhighlands.com",
    href: "/sites/cranberry-highlands",
    category: "Golf Course",
    desc: "Best municipal course in PA. 90+ sand bunkers, championship layout. Opened 2002 by Cranberry Township.",
    image: "/sites/cranberry-highlands/hero.jpg",
    logo: "/sites/cranberry-highlands/logo.png",
  },
  {
    name: "Conley Resort & Golf Club",
    url: "conleyresort.com",
    href: "/sites/conley-resort",
    category: "Golf Course",
    desc: "Full resort — 18 holes, hotel, indoor waterpark, restaurant, and banquet facilities. Par 70, 6,475 yards in Butler County.",
    image: "/sites/conley-resort/hero.jpg",
    logo: "/sites/conley-resort/logo.png",
  },
  {
    name: "Strawberry Ridge Golf Course",
    url: "strawberryridgegolf.com",
    href: "/sites/strawberry-ridge",
    category: "Golf Course",
    desc: "Ridge-top 18 holes with panoramic views in Harmony, PA. Par 70, bar & restaurant on site. Scenic and affordable.",
    image: "/sites/strawberry-ridge/hero.jpg",
    logo: "/sites/strawberry-ridge/logo.png",
  },
  {
    name: "Beaver Valley Golf Club",
    url: "beavervalleygolf.com",
    href: "/sites/beaver-valley-golf",
    category: "Golf Course",
    desc: "4th oldest golf course in Pennsylvania, est. 1898. Par 72, 6,300 yards with panoramic Beaver River valley views.",
    image: "/sites/beaver-valley/hero.jpg",
    logo: "/sites/beaver-valley/logo.png",
  },
  {
    name: "Pheasant Ridge Golf Club",
    url: "pheasantridgegolf.com",
    href: "/sites/pheasant-ridge",
    category: "Golf Course",
    desc: "18 holes, 6,600 yards in Gibsonia. New management, fresh energy. Challenging wooded layout since 1998.",
    image: "/sites/pheasant-ridge/hero.jpg",
    logo: "/sites/pheasant-ridge/logo.png",
  },
  {
    name: "Shadow Lakes Golf Club",
    url: "shadowlakesgolf.com",
    href: "/sites/shadow-lakes",
    category: "Golf Course",
    desc: "Lake-lined 18 holes near Raccoon Creek State Park. Seven lakes, dramatic water hazards, and Magg's Restaurant.",
    image: "/sites/shadow-lakes/hero.jpg",
    logo: "/sites/shadow-lakes/logo.png",
  },
  {
